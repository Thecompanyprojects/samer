...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(indexChangeClick) name:@"indexChangepost" object:nil];
}
...
-(void)createDataType:(NSString *)type{
    ...
    if (_index == 0) {
        parameters = @{@"uid":[[NSUserDefaults standardUserDefaults] objectForKey:@"uid"],@"lat":[[NSUserDefaults standardUserDefaults] objectForKey:latitude]?:@"0",@"lng":[[NSUserDefaults standardUserDefaults] objectForKey:longitude]?:@"0",@"type":@"1",@"tid":self.tid,@"page":[NSString stringWithFormat:@"%d",_page],@"loginuid":[[NSUserDefaults standardUserDefaults] objectForKey:@"uid"],@"lastid":lastid};
        
    }
    else{
        
        parameters = @{@"uid":[[NSUserDefaults standardUserDefaults] objectForKey:@"uid"],@"lat":[[NSUserDefaults standardUserDefaults] objectForKey:latitude]?:@"0",@"lng":[[NSUserDefaults standardUserDefaults] objectForKey:longitude]?:@"0",@"tid":self.tid,@"type":@"4",@"page":[NSString stringWithFormat:@"%d",_page],@"loginuid":[[NSUserDefaults standardUserDefaults] objectForKey:@"uid"],@"lastid":lastid};
