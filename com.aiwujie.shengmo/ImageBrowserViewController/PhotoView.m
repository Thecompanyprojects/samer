...
-(UIImageView *)imageView{
    ...
    if (_imageView==nil) {
        ...
        UILongPressGestureRecognizer *press=[[UILongPressGestureRecognizer alloc] initWithTarget:self action:@selector(showCurrentVC:)];
...
-(void)showCurrentVC:(UIGestureRecognizer *)press{
