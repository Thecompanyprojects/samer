...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self addSubview:self.kickedBtn];
...
-(void)changeViewsfrom:(infoModel *)model
{
    ...
    [self.focusBtn setTitle:@"关注" forState:normal];
    self.isfocus = true;
    if ([model.follow_state intValue]==1) {
        [self.focusBtn setTitle:@"已关注" forState:normal];
        self.isfocus = false;
    }
    if ([model.follow_state intValue]==3) {
        [self.focusBtn setTitle:@"互为好友" forState:normal];
        self.isfocus = false;
    }
}
...
-(void)setuplayout
{
    ...
    [weakSelf.focusBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(weakSelf.charmView.mas_bottom).with.offset(12);
        make.centerX.equalTo(weakSelf);
        make.width.mas_offset(70);
        make.height.mas_offset(28);
    }];
    [weakSelf.giftBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.width.mas_offset(70);
        make.height.mas_offset(28);
        make.top.equalTo(weakSelf.focusBtn);
        make.right.equalTo(weakSelf.focusBtn.mas_left).with.offset(-20);
    }];
    [weakSelf.noticeBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.width.mas_offset(70);
        make.height.mas_offset(28);
        make.top.equalTo(weakSelf.focusBtn);
        make.left.equalTo(weakSelf.focusBtn.mas_right).with.offset(20);
    }];
    
    [weakSelf.bannedBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.width.mas_offset(70);
        make.height.mas_offset(28);
        make.top.equalTo(weakSelf.giftBtn.mas_bottom).with.offset(12);
        make.centerX.equalTo(weakSelf);
    }];
    [weakSelf.mikeBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.width.mas_offset(70);
        make.height.mas_offset(28);
        make.top.equalTo(weakSelf.bannedBtn);
        make.right.equalTo(weakSelf.bannedBtn.mas_left).with.offset(-20);
    }];
    [weakSelf.kickedBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.width.mas_offset(70);
        make.height.mas_offset(28);
        make.top.equalTo(weakSelf.bannedBtn);
        make.left.equalTo(weakSelf.bannedBtn.mas_right).with.offset(20);
    }];
...
-(UIButton *)giftBtn
{
    if(!_giftBtn)
    {
        ...
        [_giftBtn setTitle:@"送礼" forState:normal];
        _giftBtn.titleLabel.font = [UIFont systemFontOfSize:12];
        [_giftBtn setTitleColor:[UIColor whiteColor] forState:normal];
        _giftBtn.backgroundColor = [UIColor bm_colorGradientChangeWithSize:CGSizeMake(80, 34) direction:IHGradientChangeDirectionDownDiagonalLine startColor:[UIColor colorWithHexString:@"#FC83F5" alpha:1] endColor:[UIColor colorWithHexString:@"#DB5DE2" alpha:1]];
        _giftBtn.layer.masksToBounds = YES;
        _giftBtn.layer.cornerRadius = 14;
...
-(UIButton *)focusBtn
{
    if(!_focusBtn)
    {
        ...
        [_focusBtn setTitle:@"关注" forState:normal];
        _focusBtn.titleLabel.font = [UIFont systemFontOfSize:12];
        [_focusBtn setTitleColor:[UIColor whiteColor] forState:normal];
        _focusBtn.backgroundColor = [UIColor bm_colorGradientChangeWithSize:CGSizeMake(80, 34) direction:IHGradientChangeDirectionUpwardDiagonalLine startColor:[UIColor colorWithHexString:@"#FC83F5" alpha:1] endColor:[UIColor colorWithHexString:@"#DB5DE2" alpha:1]];
...
-(UIButton *)noticeBtn
{
    if(!_noticeBtn)
    {
        ...
        [_noticeBtn setTitle:@"@Ta" forState:normal];
        _noticeBtn.titleLabel.font = [UIFont systemFontOfSize:12];
        [_noticeBtn setTitleColor:[UIColor whiteColor] forState:normal];
        _noticeBtn.backgroundColor = [UIColor bm_colorGradientChangeWithSize:CGSizeMake(80, 34) direction:IHGradientChangeDirectionUpwardDiagonalLine startColor:[UIColor colorWithHexString:@"#FC83F5" alpha:1] endColor:[UIColor colorWithHexString:@"#DB5DE2" alpha:1]];
        _noticeBtn.layer.masksToBounds = YES;
        _noticeBtn.layer.cornerRadius = 14;
    }
    return _noticeBtn;
}
...
-(UIButton *)mikeBtn
{
    if(!_mikeBtn)
    {
        ...
        _mikeBtn.backgroundColor = [UIColor bm_colorGradientChangeWithSize:CGSizeMake(80, 34) direction:IHGradientChangeDirectionUpwardDiagonalLine startColor:[UIColor colorWithHexString:@"#FC83F5" alpha:1] endColor:[UIColor colorWithHexString:@"#DB5DE2" alpha:1]];
...
-(UIButton *)bannedBtn
{
    if(!_bannedBtn)
    {
        ...
        [_bannedBtn setTitle:@"禁言" forState:normal];
        _bannedBtn.titleLabel.font = [UIFont systemFontOfSize:12];
        [_bannedBtn setTitleColor:[UIColor whiteColor] forState:normal];
        _bannedBtn.backgroundColor = [UIColor bm_colorGradientChangeWithSize:CGSizeMake(80, 34) direction:IHGradientChangeDirectionUpwardDiagonalLine startColor:[UIColor colorWithHexString:@"#FC83F5" alpha:1] endColor:[UIColor colorWithHexString:@"#DB5DE2" alpha:1]];
        _bannedBtn.layer.masksToBounds = YES;
        _bannedBtn.layer.cornerRadius = 14;
    }
    return _bannedBtn;
}
...
-(UIButton *)kickedBtn
{
    if(!_kickedBtn)
    {
        _kickedBtn = [[UIButton alloc] init];
        [_kickedBtn setTitle:@"踢出" forState:normal];
        _kickedBtn.titleLabel.font = [UIFont systemFontOfSize:12];
        [_kickedBtn setTitleColor:[UIColor whiteColor] forState:normal];
        _kickedBtn.backgroundColor = [UIColor bm_colorGradientChangeWithSize:CGSizeMake(80, 34) direction:IHGradientChangeDirectionUpwardDiagonalLine startColor:[UIColor colorWithHexString:@"#FC83F5" alpha:1] endColor:[UIColor colorWithHexString:@"#DB5DE2" alpha:1]];
        _kickedBtn.layer.masksToBounds = YES;
        _kickedBtn.layer.cornerRadius = 14;
