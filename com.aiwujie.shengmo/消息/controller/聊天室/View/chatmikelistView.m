...
@interface chatmikelistView()<UITableViewDataSource,UITableViewDelegate>
@property (nonatomic,strong) UILabel *titleLab;
@property (nonatomic,strong) UIView *headView;
@end
static NSString *mikelistidentfity = @"mikelistidentfity";


@implementation chatmikelistView
...
{
    userinfoCell *cell = [tableView dequeueReusableCellWithIdentifier:mikelistidentfity];
    cell = [[userinfoCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:mikelistidentfity];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.delegate) {
        [self.delegate mikelistinfovc:model.uid];
    }
}
