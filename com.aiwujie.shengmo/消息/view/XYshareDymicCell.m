...
@implementation XYshareDymicCell
...
- (void)initialize
{
    ...
    self.titleLab.text = @"hi,给你推荐一个动态";
    ...
    self.contentLab.frame = CGRectMake(70, 38, 120, 50);
...
- (void)setAutoLayout
{
    XYsharedymicContent *richMessage = (XYsharedymicContent *)self.model.content;
    ...
    [self.iconImg sd_setImageWithURL:[NSURL URLWithString:richMessage.icon] placeholderImage:[UIImage imageNamed:@"圣魔logo"]];
