...
static NSString *share_tools_loader = @"share_tools_loader";
@implementation XYshareuserinfoContent
/// NSCoding
...
{
    XYshareuserinfoContent *msg = [[XYshareuserinfoContent alloc] init];
